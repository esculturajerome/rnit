    ...
    <>
      <footer className="bg-main">
        <div className="container pt-12 p-6 mx-auto">
          ...
          <div>
            <p className="text-center text-white/60 font-serif text-sm mt-8">
          ...
          <div className="flex justify-between mb-12">
            <div>
              ...
              <ul className="space-y-2">
                <li className="btn-text text-white">Media team contacts</li>
                <li className="btn-text text-white">
                  Find a subject matter expert
                </li>
                <li className="btn-text text-white">UQ news</li>
              </ul>
            </div>
            <div>
              <p>Media</p>
            ...
            <div>
              <p>Media</p>
              <ul>
                <li className="btn-text text-white">Find a researcher</li>
                <li className="btn-text text-white">
          ...
          <div className="w-full md:max-w-md">
            ...
            <div className="mt-2 ">
              <p className="text-sm text-white font-serif">
                A Transparency Seal, prominently displayed on the main page of
                the website of a particular government agency, is a certificate
                that it has complied with the requirements of Section 93. This
                Seal links to a page within the agency’s website which contains
                an index of downloadable items of each of the above-mentioned
                documents.
              </p>
            </div>
          </div>

          <div className="flex flex-col justify-between pt-5 pb-10 sm:flex-row font-serif text-sm">
