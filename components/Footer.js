          ...
          <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-4">
            <div className="md:max-w-md lg:col-span-2">
              ...
              <div className="mt-4 lg:max-w-sm">
                ...
                <p className="text-sm text-white font-serif">
                  emailant@tesda.gov.ph
                </p>
                <p className="text-sm text-white font-serif">09985731845</p>
                <p className="text-sm text-white font-serif">09487705807</p>
              </div>
            </div>
            <div className="md:max-w-md lg:col-span-2">
              <a
                ...
                className="inline-flex items-center"
              >
                <Image src={seal} width={50} height={50} objectFit="contain" />
              </a>
              <div className="mt-2 lg:max-w-sm">
                <p className="text-sm text-white font-serif">
