            ...
            <div className="flex gap-4 flex-col items-start">
                ...
                {(title || subText) && (
                    <div className="flex gap-2 flex-col">
                        {title && (
                            <h2 className="text-xl md:text-3xl tracking-tighter max-w-xl font-regular text-left">
                                {title}
                            </h2>
                        )}
                        {subText && (
                            <p className=" max-w-xl lg:max-w-lg leading-relaxed tracking-tight  text-left">
                                {subText}
                            </p>
                        )}
                    </div>
